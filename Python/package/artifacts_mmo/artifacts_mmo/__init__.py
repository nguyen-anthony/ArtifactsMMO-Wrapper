...
class ContentMaps:
    ...
    woodcutting: ContentMap = field(default_factory=lambda: ContentMap(name="Pig", code="woodcutting", level=19, skill="combat", pos=Position(-2, -3), drops=['Drop(code="pig_skin", rate=12, min_quantity=1, max_quantity=1)']))
    ...
    monsters: ContentMap = field(default_factory=lambda: ContentMap(name="Cow", code="monsters", level=8, skill="combat", pos=Position(1, 2), drops=['Drop(code="raw_beef", rate=10, min_quantity=1, max_quantity=1)', 'Drop(code="milk_bucket", rate=12, min_quantity=1, max_quantity=1)', 'Drop(code="cowhide", rate=8, min_quantity=1, max_quantity=1)']))
    ...
    jewelrycrafting: ContentMap = field(default_factory=lambda: ContentMap(name="Owlbear", code="jewelrycrafting", level=30, skill="combat", pos=Position(1, 3), drops=['Drop(code="owlbear_hair", rate=12, min_quantity=1, max_quantity=1)']))
    alchemy: ContentMap = field(default_factory=lambda: ContentMap(name="Owlbear", code="alchemy", level=30, skill="combat", pos=Position(2, 3), drops=['Drop(code="owlbear_hair", rate=12, min_quantity=1, max_quantity=1)']))       
    ...
    items: ContentMap = field(default_factory=lambda: ContentMap(name="Cultist Acolyte", code="items", level=33, skill="combat", pos=Position(4, 13), drops=['Drop(code="magic_stone", rate=12, min_quantity=1, max_quantity=1)', 'Drop(code="cursed_book", rate=20, min_quantity=1, max_quantity=1)']))
